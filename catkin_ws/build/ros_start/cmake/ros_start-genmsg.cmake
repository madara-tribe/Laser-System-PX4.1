...
get_filename_component(_filename "/home/hagi/Downloads/catkin_ws/src/ros_start/srv/SetVelocity.srv" NAME_WE)
add_custom_target(_ros_start_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_start" "/home/hagi/Downloads/catkin_ws/src/ros_start/srv/SetVelocity.srv" ""
)
...
_generate_srv_cpp(ros_start
  "/home/hagi/Downloads/catkin_ws/src/ros_start/srv/SetVelocity.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_start)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_start\")")
  # install generated code
  install(
